      ...
      <div className="sign__form-container">
        <form className="sign__form" name="sign-form" onSubmit={handleSubmit}>
          ...
          <fieldset className="sign__fieldset">
            <input type="email" value={values.email ? values.email : ""} onChange={handleChange} className="sign__input" placeholder="Email" name="email" required minLength="2" maxLength="40" />
