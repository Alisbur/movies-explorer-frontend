    ...
    <article className="movies-card">
      ...
      <div className="movies-card__item-info">
        <div className="movies-card__like-div">
          ...
          {props.drawSaved 
            ? (<button type="button" onClick={()=>{}} className="movies-card__delete-button button-transparency" aria-label="Поставить лайк"></button>)
            : (<button type="button" onClick={()=>{}} className={`movies-card__like-button ${props.card.saved && "movies-card__like-button_active"} button-transparency`} aria-label="Поставить лайк"></button>)
          }
        </div>        
