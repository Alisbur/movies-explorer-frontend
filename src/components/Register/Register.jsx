        ...
        <div className="register__content">
          <form className="register__form" name="register-form" onSubmit={handleSubmit}>
            ...
            <fieldset className="register__fieldset">
              ...
              <input type="text" onChange={handleChange} className={`register__input ${errors.name && "register__input_type_error"}`} placeholder="Имя" name="name" required minLength="2" maxLength="40" autoComplete="new-password" />
            ...
            <fieldset className="register__fieldset">
              ...
              <input type="email" onChange={handleChange} className={`register__input ${errors.email && "register__input_type_error"}`} placeholder="Адрес электронной почты" name="email" required minLength="2" maxLength="40" autoComplete="new-password" />
